...
const validationSchema = yup.object().shape({
  phone: yup.number().required("Campo obrigatório").positive("Deve ser um número positivo").integer("Deve ser um número inteiro"),
  password: yup
    .string()
      ...
      >
        {({ handleChange, handleBlur, handleSubmit, values, errors, touched }) => (
          <View style={login_style.containerForm}>
            <Text style={[login_style.title, { fontFamily: "Poppins_700Bold" }]}>
              Login
            </Text>
            ...
            <TouchableOpacity>
              <Text
                style={[login_style.info, { fontFamily: "Poppins_400Regular" }]}
              >
                Esqueceu sua senha?
              </Text>
            </TouchableOpacity>
